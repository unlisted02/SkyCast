...
const Detail = ({ darkMode }) => {
    ...
    const city = 'New York';
    const daysInfo = [
        { name: 'Monday', temp: 70, state: 'Sunny' },
        { name: 'Tuesday', temp: 68, state: 'Cloudy' },
        { name: 'Wednesday', temp: 72, state: 'Sunny' },
        { name: 'Thursday', temp: 74, state: 'Clear' },
        { name: 'Friday', temp: 71, state: 'Rain' },
    ];
    ...
    return (
        <div className={`details-page__wrapper ${darkMode && 'details-page__wrapper-dark'}`}>
            ...
            <svg className="back__button" viewBox="4085 152 98.5 126" tabIndex="0">
            ...
            <section className="main-weather__card">
                <section className="card-header__container-dark" >
                    <img className="city__illustration" src={getCityIllustrationPath("paris")} />
                    <div className="header-content__wrapper">
                        ...
                        <div className="city-name__container">
                            <div className="city-name__underline">
                                <span className="city-name__text">{city}</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <main className="body-content__wrapper">
                    <section className="twitter-feed__container">
                        <div className="twitter-feed__header">
                            ...
                            <span className="twitter-feed-tag__text">#{city}</span>
                        </div>
